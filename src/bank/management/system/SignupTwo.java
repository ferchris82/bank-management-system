...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        String valReligion [] = {"Catholic", "Christian", "Muslim",
        "Hindu", "Other"};
        ...
        String educationValues[] = {"Non-Graduation","Graduate", "Post-Graduation",
            "Doctrate", "Other"}; 
        ...
        String occupationValues[] = {"Salaried", "Self-Employed", "Bussiness",
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            String query = "INSERT INTO signuptwo VALUES('"+formno+"',"
                    + " '"+sreligion+"', '"+scategory+"','"+sincome+"', '"+seducation+"',"
